...
| --- | --- |
|Investors|Investors are those who finance and believe in our product.

They are likely to have prior business experience involving the marketing and likely the development of software (mobile applications, etc.). 

Investors classify as stakeholders because they are directly impacted by the success of our product. More specifically, they are financially bound to our products success.|
|Stakeholders|Description|
